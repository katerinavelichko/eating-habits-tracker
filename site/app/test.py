...
def make_df_for_model(current_user, QuestionsSleep):
    ...
    translated_data = {
        key: eng_answers[value] if value in eng_answers else value
    ...
    res = {
        "alcoholic_beverages": "How many times do you consume alcoholic beverages in a week?",
    ...
    for key, value in translated_data.items():
        if key in food_db:
            ...
            answer_dict[new_key_no] = 1 if value == "No" else 0
            answer_dict[new_key_elaborate] = (
                1 if value == "I cook more elaborate" else 0
            )
